      ...
      <div className="max-w-7xl mx-auto px-4 pt-24">
        <section className="min-h-screen flex items-center">
          <div className="space-y-4">
            ...
            >
              I&apos;m a Cloud Engineer / DevOps specialist focused on building
              scalable, secure, and automated cloud infrastructure. Currently,
              I&apos;m focused on implementing Infrastructure as Code and CI/CD
              pipelines.
            </p>
          </div>
        </section>
